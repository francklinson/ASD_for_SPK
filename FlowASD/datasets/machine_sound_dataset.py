...
machine_id_to_class_label = dict(ToyCar_id_01=0, ToyCar_id_02=1, ToyCar_id_03=2, ToyCar_id_04=3,
                                 ...
                                 valve_id_00=19, valve_id_02=20, valve_id_04=21, valve_id_06=22, ToyCar_id_05=23,
                                 ToyCar_id_06=24, ToyCar_id_07=25,
...
class MachineSoundDataset(Dataset):
    ...
    def __init__(self, root_dir, subset_path, machine_id, preprocessing_fn, preprocessing_name,
        ...
        spectrograms_path = os.path.join(CACHE_DIR, create_unique_dataset_name(subset_path + "_" + str(machine_id),
                                                                               preprocessing_name,
                                                                               preprocessing_params) + ".pt")
        if os.path.exists(spectrograms_path):
            ...
            for i, fi in enumerate(self.files):
                self.spectrograms.append(
                    self.preprocessing_fn(os.path.join(self.root_dir, fi), **self.preprocessing_params))
                if i % 100 == 0:
                    print(i)
