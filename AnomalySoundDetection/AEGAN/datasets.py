...
from AnomalySoundDetection.AEGAN import utils
...
class BaseSet:
    ...
    def cal_spec(self, mt):
        ...
        self.seg_per_clip = (all_clip_spec.shape[-1] - self.pm['feat']['frame_num'] + 1) // self.pm['feat'][
            'graph_hop_f']
